    ...
    return (
        <div className="min-h-screen">
            <div className="pt-20 mx-auto max-w-6xl px-4">
                <h2 className="text-gray-800 text-2xl text-center mb-6">
                    Bag Your Skills
                </h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    <div className="sm:col-span-2 lg:col-span-2">
                        <div className="grid grid-cols-1 gap-4">
                            ...
                            <Link to="/courses">
                                <button className="mt-4 px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 mx-1">
                                    Add More
                                </button>
                            </Link>
                        </div>
                    ...
                    <div className="bg-amber-200 p-4 rounded shadow-md border border-gray-300 lg:max-h-[300px]">
                        <h3 className="text-xl font-semibold bg-transparent text-gray-800">
                            Summary
                        </h3>
                        <p>
